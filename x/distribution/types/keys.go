...
var (
	CreatorPoolKey                    = []byte{0x00} // key for global distribution state
	FeePoolKey                        = []byte{0x01} // key for global distribution state
	ProposerKey                       = []byte{0x02} // key for the proposer operator address
	ValidatorOutstandingRewardsPrefix = []byte{0x03} // key for outstanding rewards

	DelegatorWithdrawAddrPrefix          = []byte{0x04} // key for delegator withdraw address
	DelegatorStartingInfoPrefix          = []byte{0x05} // key for delegator starting info
	ValidatorHistoricalRewardsPrefix     = []byte{0x06} // key for historical validators rewards / stake
	ValidatorCurrentRewardsPrefix        = []byte{0x07} // key for current validator rewards
	ValidatorAccumulatedCommissionPrefix = []byte{0x08} // key for accumulated validator commission
	ValidatorSlashEventPrefix            = []byte{0x09} // key for validator slash fraction
)
